...
export async function AdminDashboard() {
  ...
  const pendingProblems = await prisma.problem.findMany({
    where: {
      OR: [{ adminApproved: false }, { status: "OPEN" }],
    },
        ...
        <TabsList>
          ...
          <TabsTrigger value="approvals" className="relative">
            ...
            {(pendingApplications.length > 0 ||
              pendingProblems.filter((p) => !p.adminApproved).length > 0) && (
        ...
        <TabsContent value="approvals" className="mt-4 space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Review and provide final authorization for problems to enter the marketplace.
              </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    >
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          By {problem.submitter.name} ({problem.submitter.role})
                        </p>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        {!problem.adminApproved && (
                          <form
                            action={async () => {
                              "use server";
                              await approveProblem(problem.id, "ADMIN", true);
                            }}
                          >
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Admins can provide the final override or approval for student node applications.
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="users" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                View all users and log in as them without a password to troubleshoot or manage
                problems.
              </CardDescription>
            </CardHeader>
            <CardContent>
