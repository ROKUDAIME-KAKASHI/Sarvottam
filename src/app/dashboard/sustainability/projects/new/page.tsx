...
} from "@/lib/actions/sustainability.actions";
      ...
      <Card>
        <form onSubmit={handleSubmit}>
          <CardHeader>
            ...
            <CardDescription>
              Launch an initiative and map it to UN Sustainable Development Goals.
            </CardDescription>
          </CardHeader>
          ...
          <CardFooter className="flex justify-between">
            ...
            <Button
              type="submit"
              disabled={loading || !formData.title || formData.sdgIds.length === 0}
            >
