            ...
            >
              ...
              >
                <CardContent className="p-4 sm:p-6 flex items-start gap-4 sm:gap-6 relative">
                  ...
                  <div
                    className={`mt-1 h-10 w-10 shrink-0 rounded-full flex items-center justify-center ${notif.read ? "bg-muted text-muted-foreground" : "bg-primary/10 text-primary"}`}
                  >
                  ...
                  <div className="flex-1 space-y-1">
                    <div className="flex items-center justify-between">
                      <p
                        className={`text-sm sm:text-base ${notif.read ? "font-medium" : "font-bold"} text-foreground`}
                      >
                        Notification
                      </p>
