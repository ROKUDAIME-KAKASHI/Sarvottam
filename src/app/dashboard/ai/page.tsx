      ...
      <div className="flex items-center space-x-3 mb-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Personalized insights and recommendations powered by Sarvottam AI.
          </p>
        </div>
      </div>
        ...
        {session.user.role === "STUDENT" && (
          <>
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  <Briefcase className="w-5 h-5 mr-2" /> Recommended Projects
                </CardTitle>
                <CardDescription>
                  Vector-matched based on your skills and interests.
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  <UserCheck className="w-5 h-5 mr-2" /> Recommended Faculty
                </CardTitle>
            ...
            <Card className="col-span-2 border-primary/50 bg-primary/5">
              <CardHeader>
                <CardTitle className="flex items-center text-primary">
                  <Sparkles className="w-5 h-5 mr-2" /> Skill Gap Analysis
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="font-medium mb-2">Identified Missing Skills:</p>
                <div className="flex gap-2 flex-wrap mb-4">
                  {aiData.skillGap?.missingSkills.map((s: string) => (
        ...
        {session.user.role === "SUPERADMIN" && (
          <>
            <Card className="col-span-2">
              <CardHeader>
                <CardTitle className="flex items-center">
                  <Activity className="w-5 h-5 mr-2" /> Executive Summary
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  <Sparkles className="w-5 h-5 mr-2" /> Predictive Insights
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center text-red-500">
                  <AlertTriangle className="w-5 h-5 mr-2" /> Detected Anomalies
                </CardTitle>
              </CardHeader>
              <CardContent>
