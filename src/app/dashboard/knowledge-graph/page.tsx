      ...
      <div className="flex items-center space-x-3 mb-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Discover semantic relationships between problems, research, and startups.
          </p>
        </div>
      </div>
          ...
          <CardContent className="space-y-4">
            {edges.map((edge) => {
              ...
              return (
                <div
                  key={edge.id}
                  className="flex items-center space-x-2 text-sm bg-secondary/50 p-3 rounded-md"
                >
                  <div
                    className="flex items-center space-x-1 font-medium w-1/3 truncate"
                    title={src.label}
                  >
