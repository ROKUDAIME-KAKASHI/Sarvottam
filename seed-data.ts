...
async function main() {
  ...
  if (superAdmin) {
    projects.push({
      ...
      description: "Developing a central dashboard to track student placement rates, faculty publications, and cross-departmental collaboration metrics. This project involves aggregating fragmented data sources into a unified data warehouse and creating interactive visualizations.",
      type: "Business",
  ...
  if (faculty) {
    projects.push({
      ...
      description: "Researching the application of large language models (LLMs) to automatically grade and provide feedback on long-form essay questions. We aim to train a specialized model on past academic essays to reduce grading time while maintaining high evaluation standards.",
      type: "Research",
      difficultyLevel: "Advanced",
      duration: "12 Months",
      status: "OPEN",
    ...
    projects.push({
      ...
      description: "A collaborative effort to synthesize biodegradable polymers using agricultural waste. This research will catalog various waste materials and test their efficacy as base components for bioplastics.",
      type: "Research",
  ...
  if (industry) {
    projects.push({
      ...
      description: "Creating a predictive algorithm to anticipate supply chain disruptions in the manufacturing sector. The project requires analyzing historical shipment data, weather patterns, and global economic indicators.",
      type: "Software",
      difficultyLevel: "Advanced",
      duration: "4 Months",
      status: "IN_PROGRESS",
  ...
  if (student) {
    projects.push({
      ...
      description: "Building a Python-based web scraper that periodically extracts real estate pricing from multiple regional websites to build a predictive pricing model for local neighborhoods.",
      type: "Software",
    ...
    projects.push({
      ...
      description: "Developing an isolated, virtualized sandbox environment written in Python to safely execute and analyze behavioral patterns of suspicious executables.",
      type: "Technical",
      difficultyLevel: "Intermediate",
      duration: "3 Months",
      status: "OPEN",
  ...
  if (jin) {
    projects.push({
      ...
      description: "A React Native application designed to help new students navigate the university campus, including indoor mapping of large lecture halls, library sections, and real-time cafeteria menus.",
      type: "Software",
      difficultyLevel: "Intermediate",
      duration: "4 Months",
      status: "OPEN",
  ...
  if (isha) {
    projects.push({
      ...
      description: "A research project focusing on the evolution of narrative tropes in 21st-century literature. Using Google Docs for collaborative tagging and Data Analysis tools to chart the frequency and thematic variations across a dataset of 500 modern novels.",
      type: "Research",
      difficultyLevel: "Intermediate",
      duration: "6 Months",
      status: "OPEN",
    ...
    projects.push({
      ...
      description: "Working on formatting, transcribing, and assigning metadata to a local historical archive. The goal is to make these physical documents fully searchable online.",
      type: "Design",
      difficultyLevel: "Beginner",
      duration: "3 Months",
      status: "OPEN",
